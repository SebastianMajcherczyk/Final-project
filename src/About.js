    ...
    return (
        <div className="container about" id="about">
            <div className="about-left">
                ...
                <p>Lorem ipsum dolor sit amet, conse etuer adipiscing
            ...
            <div className="about-right">
                ...
                <div className=" ab-lft">
                    <h4>VIRTUAL PHONE SYSTEM</h4>
                    <p>Lorem ipsum dolor sit amet, conse etuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                        ut laoreet dolore magn aliquam erat volutpat massa dolore orem ipsum dolor sit amet,
                        conse etuer adipiscing elit, sed conse etuer adipiscing elitconse etuer adipiscing elit.</p>
                </div>
                <div className="ab-lft">
